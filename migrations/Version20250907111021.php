 ...
 */
final class Version20250907111021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id SERIAL NOT NULL, organizer_id INT NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE "user" ADD organizer_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE "user" ADD CONSTRAINT FK_8D93D649876C4DDA FOREIGN KEY (organizer_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE INDEX IDX_8D93D649876C4DDA ON "user" (organizer_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" DROP CONSTRAINT FK_8D93D649876C4DDA');
        $this->addSql('DROP INDEX IDX_8D93D649876C4DDA');
        $this->addSql('ALTER TABLE "user" DROP organizer_id');
    }
}
